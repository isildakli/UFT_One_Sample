...
Browser("Avansas - Ofis Malzemeleri_2").Page("HP Toner Fiyatları | Avansas").WebElement("WebElement").Click @@ script infofile_;_ZIP::ssf20.xml_;_
Browser("Avansas - Ofis Malzemeleri_2").Page("HP Toner Fiyatları | Avansas").Link("Sepetime Git").Click @@ script infofile_;_ZIP::ssf21.xml_;_
Browser("Avansas - Ofis Malzemeleri_2").Page("Sepetim").WebElement("Sepeti Boşalt").Click @@ script infofile_;_ZIP::ssf22.xml_;_
